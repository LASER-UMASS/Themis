/*
Group discrimination testing for Subject System B( Credit dataset)
Inputs :
    argv[1] : Train file
*/
#include <math.h>
...
void check_ratio(vector<int> fixed, node* root,vvs tableInfo, string defaultClass ){
    ...
    ofstream fout;
    //Output file
    string outfile="../../Suites/freshBcredit99.txt";
    ...
    if (option==3 || option==4){
        ...
        cout<<"Score is  "<<(max-min)*100<<endl;
