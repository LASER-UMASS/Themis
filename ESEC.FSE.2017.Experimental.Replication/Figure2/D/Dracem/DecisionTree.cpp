/*
Causal discrimination testing for Subject System D
Inputs :
    argv[1] : Train file
    argv[2] :  Attribute to test discrimination against
*/
#include "header.h"
#include <stdexcept>
#include <stdio.h>
...
void check_ratio(vector<int> fixed, node* root,vvs tableInfo, string defaultClass ){
    ...
    ofstream fout;
    int option=4;
    string outfile="../../Suites/freshDcausalrmarital.txt";
    ...
    string decision;
    string already = "../../Suites/Dcausalrmarital.txt";
    if (option==3 || option==4){
        int fixval=atoi(fixedatr.c_str());
        ifstream fin;
    ...
    cout<<"score is "<<pos*1.0/(pos+neg)<<endl;
