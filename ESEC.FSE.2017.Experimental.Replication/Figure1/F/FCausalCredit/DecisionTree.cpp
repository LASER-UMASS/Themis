/*
Causal discrimination testing for Subject System F for credit dataset
Inputs :
    argv[1] : Train file
...
void check_ratio(vector<int> fixed, node* root,vvs tableInfo, string defaultClass ){
    ...
    ofstream fout;
    int option=4;
    string outfile="../../Suites/freshFcausalcredit99.txt";
    fout.open(outfile,ios::out);
    
    string decision;
    string already = "../../Suites/Fcausalcredit";
