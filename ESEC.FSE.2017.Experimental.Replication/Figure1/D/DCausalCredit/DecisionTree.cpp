/*
Causal discrimination testing for Subject System D for Credit dataset
Inputs :
    argv[1] : Train file
*/
#include "header.h"
...
void check_ratio(vector<int> fixed, node* root,vvs tableInfo, string defaultClass ){
    ...
    string outfile="../../Suites/freshDcausalcredit99.txt";
    fout.open(outfile,ios::out);
    
    
    string decision;
    string already = "../../Suites/Dcausalcredit";
