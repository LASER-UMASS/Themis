...
public class AdditiveRegression extends IteratedSingleClassifierEnhancer 
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option(
	      "\tSpecify Discrimination rate. "
	      +"(default = 1.0, ie. no sfdfdhrinkage)\n", 
	      "S", 1, "-S"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    System.out.println("The string"+optionString);
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    int cc=0;
    System.out.println("The selected classifier is =: "+m_Classifiers[cc++]);
