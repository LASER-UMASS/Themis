...
/*changes in class ClassifierPanel due to discrimination
 * Change 1 : for  classification without SA
 * change 2:  sets the flag to remove SA from train and test set for  classification without SA
 * change 3: sets the flag to prevent the application of "Preprocessing" on full training data
 * change 4: SA determinatio; To execute the function in Discrimination class to determine the discriminatory attidute of differen attribute
 * change 5: disc calculation for CV
 * change 6: to show the SA in a combo box
 * 
*/
...
/** Label by Deprived community is entered */
  protected JLabel m_ClassLab = new JLabel("Class", SwingConstants.LEFT);
  /** Lets the user select the class column */
  protected JComboBox m_ClassCombo = new JComboBox();
//change 6
  /** Label by Deprived community is entered */
  protected JLabel m_SaLab = new JLabel("SA", SwingConstants.LEFT);
  /** Lets the user select the SA column */
  protected JComboBox m_SaCombo = new JComboBox();
  /** Lets the user select the deprived community */
  protected JComboBox m_SaDepCombo = new JComboBox();
 ...
 /** Label by where the value of FAv are entered */

  protected JTextField m_FavText = new JTextField("Male");
 /** Label by Deprived community is entered */
  protected JLabel m_DepLab = new JLabel("Deprived", SwingConstants.LEFT);
  /** The field where the Deprived value of SA are entered */
  protected JTextField m_DepText = new JTextField("Female");
  ...
  ActionListener m_RadioListener = new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      ...
      //change
   ActionListener m_SaListener = new ActionListener() {
    public void actionPerformed(ActionEvent e) {
  ...
  public ClassifierPanel() {
    ...
    m_ClassifierEditor.setValue(new weka.nonDiscConstraints.J48WithNDCs());
    ...
    //change 6
    m_SaCombo.setToolTipText("Select the attribute to use as Sensitive Attribe");
   m_SaDepCombo.setToolTipText("Select the Deprived community of Sensitive Attribe");
    ...
    //change 6
    m_SaCombo.setEnabled(false);
    m_SaCombo.setPreferredSize(COMBO_SIZE);
    m_SaCombo.setMaximumSize(COMBO_SIZE);
    m_SaCombo.setMinimumSize(COMBO_SIZE);
    m_SaDepCombo.setEnabled(false);
    m_SaDepCombo.setPreferredSize(COMBO_SIZE);
    m_SaDepCombo.setMaximumSize(COMBO_SIZE);
    m_SaDepCombo.setMinimumSize(COMBO_SIZE);
    m_SaCombo.addActionListener(m_SaListener);
    ...
    //change 6
      m_SaCombo.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
	int selected = m_SaCombo.getSelectedIndex();
	if (selected != -1) {
	  boolean isNominal = m_Instances.attribute(selected).isNominal();
	 // m_OutputPerClassBut.setEnabled(isNominal);
	 // m_OutputConfusionBut.setEnabled(isNominal);
    ...
    JPanel saOptions = new JPanel();
    GridBagLayout gbL1 = new GridBagLayout();
    saOptions.setLayout(gbL1);
   //saOptions.setLayout(new GridLayout(2,2));
    saOptions.setBorder(BorderFactory.createCompoundBorder(
		 BorderFactory.createTitledBorder("Dependency options"),
		 BorderFactory.createEmptyBorder(0, 5, 5, 5)
		 ));
    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.WEST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    gbC.gridy = 0;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 10, 2, 80);
    gbL1.setConstraints(m_SaLab, gbC);
    saOptions.add(m_SaLab);

    gbC = new GridBagConstraints();
     gbC.anchor = GridBagConstraints.EAST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    gbC.gridy = 0;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 80, 2, 10);
    gbL1.setConstraints(m_SaCombo, gbC);
    saOptions.add(m_SaCombo);
    m_SaCombo.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));//.createEmptyBorder(2, 1, 2, 1));
    ...
    gbC.gridy = 1;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 10, 2, 80);
    gbL1.setConstraints(m_DepLab, gbC);
    saOptions.add(m_DepLab);
    ...
    gbC.gridy =1;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 80, 2, 10);
    gbL1.setConstraints(m_SaDepCombo, gbC);
    saOptions.add(m_SaDepCombo);
    m_SaDepCombo.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));//.createLineBorder(Color.GRAY));//
    ...
    gbC.gridy =0;     gbC.gridx = 0;
    //gbC.insets = new Insets(2, 80, 2, 10);
    gbL.setConstraints(saOptions, gbC);
    buttons.add(saOptions);
    
    //JPanel ssButs = new JPanel();
    //ssButs.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
    //ssButs.setLayout(new GridBagLayout());
    gbL = new GridBagLayout();
    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.WEST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    gbC.gridy = 3;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 25, 2, 80);
    gbL.setConstraints(m_ClassLab, gbC);
    buttons.add(m_ClassLab);
  ...
  buttons.setLayout(gbL);
    ...
    gbC.fill = GridBagConstraints.HORIZONTAL;
    gbC.gridy = 3;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 95, 2, 25);
    gbL.setConstraints(m_ClassCombo, gbC);
    buttons.add(m_ClassCombo);
    m_ClassCombo.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));//createLineBorder(Color.gray));//createEmptyBorder(5, 1, 5, 1));

    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.WEST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    gbC.gridy =4;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 10, 2, 140);
    gbL.setConstraints(m_StartBut, gbC);
    //ssButs.add(m_StartBut);buttons
    buttons.add(m_StartBut);
    gbC = new GridBagConstraints();
    gbC.anchor = GridBagConstraints.EAST;
    gbC.fill = GridBagConstraints.HORIZONTAL;
    gbC.gridy =4;     gbC.gridx = 0;
    gbC.insets = new Insets(2, 140, 2, 10);
    gbL.setConstraints(m_StopBut, gbC);
    buttons.add(m_StopBut);
  ...
  protected void updateRadioLinks() {
    ...
    m_FavText.setEnabled(m_CVBut.isSelected());
  ...
  public void setInstances(Instances inst) {
    ...
    attribNames = new String [m_Instances.numAttributes()];
    ...
    m_SaCombo.setModel(new DefaultComboBoxModel(attribNames));
    ...
    if (attribNames.length > 0) {
      ...
      //change 6
     m_SaCombo.setSelectedIndex(0);
      m_SaCombo.setEnabled(true);
      updateSaParameters();
      m_SaDepCombo.setEnabled(true);
  ...
  public static void processClassifierPrediction(Instance toPredict,
	...
	pred = eval.evaluateModelOnce(classifier, 
      ...
      //Change 1
      int attNumWithoutSA=plotInstances.numAttributes();
      if(Discrimination.getSAA())
            attNumWithoutSA--;
    
      
 
     double [] values = new double[attNumWithoutSA];//double [] values = new double[plotInstances.numAttributes()];
      for (int i = 0; i < attNumWithoutSA; i++) //for (int i = 0; i < plotInstances.numAttributes(); i++) 
      {
...
public void updateSaParameters(){
     String [] SaValues=new String[m_Instances.attribute(m_SaCombo.getSelectedIndex()).numValues()];
     for(int v=0;v<m_Instances.attribute(m_SaCombo.getSelectedIndex()).numValues();v++)
      SaValues[v]=m_Instances.attribute(m_SaCombo.getSelectedIndex()).value(v);
      m_SaDepCombo.setModel(new DefaultComboBoxModel(SaValues));
     // m_SaDepCombo.setSelectedIndex(0);
            }
/*public void getSaParameters(){
    int saIndex=m_SaCombo.getSelectedIndex();
    int saNumVals=m_Instances.attribute(saIndex).numValues();
 try{
        if(saIndex==m_ClassCombo.getSelectedIndex())
         throw new Exception("Class Attribute can't be SA");
        else if(saNumVals!=2)
            throw new Exception("Selecte a binary attribute as SA");
        else{
          Discrimination.setSaIndex(saIndex) ;
          int SaDepIndex=m_SaDepCombo.getSelectedIndex();
          Discrimination.setSaDep(m_Instances.attribute(Discrimination.getSaIndex()).value(SaDepIndex));
          if(SaDepIndex==0)
            Discrimination.setSaFav(m_Instances.attribute(Discrimination.getSaIndex()).value(1));
          else
            Discrimination.setSaFav(m_Instances.attribute(Discrimination.getSaIndex()).value(0));
            }
   } catch (Exception ex) {
	    ex.printStackTrace();
	    m_Log.logMessage(ex.getMessage());
	    JOptionPane.showMessageDialog(ClassifierPanel.this,
					  "Problem Selecting Dependency parameters:\n"
					  + ex.getMessage(),
					  "Evaluate classifier",
 ...
 public static void discCalCondition(Instances insts){
     int caIndex=5,caValues=insts.attribute(caIndex).numValues();
     double [][][] count=new double[caValues][2][2];
     insts.setClassIndex(insts.numAttributes()-1);
     for(int i=0; i<insts.numInstances();i++){
         count[(int)insts.instance(i).value(caIndex)][(int)insts.instance(i).value(0)][(int)insts.instance(i).classValue()]+=1;
        //Discrimination.discCalculation(insts.instance(i), insts.instance(i).classValue());
     }
     double [] dep=new double[caValues];
     //double fTotal=0,mTotal=0;
     double total=0;
     for (int i=0; i<caValues;i++){
         double f=count[i][0][0]+count[i][0][1];
         double fpos=count[i][0][1];
         double m=count[i][1][0]+count[i][1][1];
         double mpos=count[i][1][1];
         
         if(mpos/m-fpos/f>=-100)
          dep[i]=((mpos/m-fpos/f)*(f+m))/1000;
         total+=dep[i];
         System.out.println("Occupation:\t"+(i+1)+"\tFemale:\t"+f+"\tmale:\t"+m+"\tDiscrimination:\t"+dep[i]*100);

     }
     System.out.println("Normal Dep:\t"+Discrimination.getDisc()+"\tTotal conditional dep:\t "+total/caValues*100);
  }
  /**
  ...
  protected void startClassifier() {
	...
	public void run() {
	  ...
	  String cname = classifier.getClass().getName();
          ...
          //System.out.println(" classifier name is    "+cname);
	  if (cname.startsWith("weka.classifiers.")) {
	    name += cname.substring("weka.classifiers.".length());
	  } else {
	    name += cname;
	  }
           Discrimination d=new Discrimination();

	  try {
               //change 6
                 //getSaParameters();
              //d.discAttributeSelection(m_Instances);
              //Discrimination.setCaValues(inst.attribute(Discrimination.getCaIndex()).numValues());
              int saIndex=m_SaCombo.getSelectedIndex();
              int saNumVals=m_Instances.attribute(saIndex).numValues();
              if(saIndex==m_ClassCombo.getSelectedIndex())
                     throw new Exception("Class Attribute can't be Sensitive Attribute");
              else if(m_Instances.attribute(saIndex).isNumeric())
                      throw new Exception("Sensitive Attribute can't numeric");
              else if(false)//(saNumVals!=2)
                       throw new Exception("Selecte a binary attribute as Sensitive Attribute");
              else{
                        Discrimination.setSaIndex(saIndex) ;
              int SaDepIndex=m_SaDepCombo.getSelectedIndex();
              Discrimination.setSaDep(m_Instances.attribute(Discrimination.getSaIndex()).value(SaDepIndex));
              //Discrimination.setSaFav(m_Instances.attribute(Discrimination.getSaIndex()).value(1-SaDepIndex));
              }
                // updateSaParameters();
	    ...
	    if (outputModel || (testMode == 3) || (testMode == 4)) {
	      ...
	      trainTimeStart = System.currentTimeMillis();
              ...
              // change 3
              Discrimination.setDepParameters(inst); // to set dependency parametered GUI explorere
              ClassiferWithNDCs.preprocess=false;     // No preprocessing on the whole dataset
	      classifier.buildClassifier(inst);
              ClassiferWithNDCs.preprocess=true;
		...
		Instances train = inst.trainCV(numFolds, fold, random);
                ...
                //change 2
               // System.out.println("deprived"+train.attribute(0).value(0) + "\t favored "+train.attribute(0).value(1));
                if(Discrimination.getSAA()){
                    Discrimination.trainInstsWithsa=train;
                    Filter m_Filter = new weka.nonDiscConstraints.RemoveSAFilter();
                    m_Filter.setInputFormat(train);
                    //System.out.println("\n Number of attributes in training set =: "+train.numAttributes());
                     train=Filter.useFilter(train, m_Filter);
                    // System.out.println("\n After filter: Number of attributes in training set =: "+train.numAttributes());
                }
		...
		Instances test = inst.testCV(numFolds, fold);
                ...
                if(Discrimination.getSAA()){
                    ...
                    m_Filter.setInputFormat(test);
                     ...
                     //System.out.println("\n After filter Number of attributes in test set =: "+test.numAttributes());
                }
		m_Log.statusMessage("Evaluating model for fold "
				    + (fold + 1) + "...");
		for (int jj=0;jj<test.numInstances();jj++) {
                    //change 2
                    Discrimination.checkSAValue(testWithSA.instance(jj));
		  ...
		  if (outputPredictionsText) { 
		    outBuff.append(predictionText(current, test.instance(jj), jj+1));
                ...
                //change 5: Disrimination Std Deviation of Disc Calculation for CV
                Discrimination.totalFolds=numFolds;
                Discrimination.DiscForCV(fold);
               // Discrimination.accuracyStd(fold);
		...
		rnd = 1;
	      ...
	      Instances train = new Instances(inst, 0, trainSize);
              System.out.println(" total instance in the traing data ( may be discriminatory)"+train.numInstances());
		...
		m_Log.logMessage("Problem copying classifier: " + ex.getMessage());
               ...
               //System.out.println("   it is Naive Bayes simple for 2nd time");
	      current.buildClassifier(train);
		...
		outBuff.append(" inst#, sVal,   actual, predicted, error");
		if (inst.classAttribute().isNominal()) {
		  outBuff.append(", probability distribution");
		}
		outBuff.append("\n");
		...
		m_Log.logMessage("Problem copying classifier: " + ex.getMessage());
           ...
           //change 2
                if(Discrimination.getSAA()){
                    Discrimination.trainInstsWithsa=inst;
                   Filter m_Filter = new weka.nonDiscConstraints.RemoveSAFilter();
                    m_Filter.setInputFormat(inst);
                    //System.out.println("\n Number of attributes in training set =: "+train.numAttributes());
                     inst=Filter.useFilter(inst, m_Filter);
                    // System.out.println("\n After filter: Number of attributes in training set =: "+train.numAttributes());
                     inst.setClassIndex(classIndex-1);
                }
               
	      current.buildClassifier(inst);
	      eval = new Evaluation(inst, costMatrix);
        ...
        //change 2
              testWithSA=userTest;
                if(Discrimination.getSAA()){
                    Filter m_Filter = new weka.nonDiscConstraints.RemoveSAFilter();
                     m_Filter.setInputFormat(userTest);
                    //System.out.println("\n Number of attributes in training set =: "+train.numAttributes());
                     userTest=Filter.useFilter(userTest, m_Filter);
                    // System.out.println("\n After filter: Number of attributes in training set =: "+train.numAttributes());
                     userTest.setClassIndex(classIndex-1);
                }
         ...
         //change 2
                  Discrimination.checkSAValue(testWithSA.instance(jj));
		processClassifierPrediction(userTest.instance(jj), current,
					    eval, predictions,
					    predInstances, plotShape,
					    plotSize);
		if (outputPredictionsText) { 
...
//change 2   
            int temp=classIndex-1;
	    if (inst.attribute(temp).isNominal()) {
                
            //if (inst.attribute(classIndex-1).isNominal()) {
 ...
 protected String predictionText(Classifier classifier, Instance inst, int instNum) throws Exception {
    ...
    // inst #
    text.append(Utils.padLeft("" + instNum, 6) + " " + inst.toString(Discrimination.sa_Index) + " ");
    if (inst.classAttribute().isNominal()) {
	...
	pred = classifier.classifyInstance(inst);
      ...
      if (pred == inst.classValue()){ 
          //Discrimination.classifierComparison(1);
          text.append(Utils.padLeft("1", 6) + " ");
      }
      else{
         // Discrimination.classifierComparison(0);
          text.append(Utils.padLeft("0", 6) + " ");
      }
...
//change to write the output in a file in formate :: T.sa   T.class T.score

      BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Documents and Settings\\fkamiran\\Desktop\\Research\\Ensembles\\Experiments\\data.txt",true)) ;
       // writer.write(inst.value(inst.attribute(Discrimination.getSaIndex()))+"\t"+inst.classValue()+"\t"+probdist[Discrimination.dc]+"\n") ;
       writer.write(inst.value(inst.attribute(Discrimination.getSaIndex()))+"\t"+inst.classValue()+"\t"+pred+"\n") ;
        writer.close() ;
    } else {
  ...
  protected void loadClassifier() {
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) {
      ...
      // System.out.println( "         this is load classifier method     ");
	...
	outBuff.append("\n");
	if (trainHeader != null) {
	  outBuff.append("Relation1:     " + trainHeader.relationName() + '\n');
